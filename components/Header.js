...
const Header = () => {
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          className="lucide lucide-pencil-line size-4"
        >
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-30 mx-auto mb-4 flex origin-bottom h-full max-h-14">
      ...
      <div className="w-max p-2 rounded-full border z-50 pointer-events-auto relative mx-auto flex min-h-full h-full items-center px-1 bg-background shadow-[0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] transform-gpu dark:border dark:border-[rgba(255,255,255,.1)] dark:shadow-[0_-20px_80px_-20px_#ffffff1f_inset]">
        {/* Navigation icons */}
        {navIcons.map((item) => (
          <div
            key={item.name}
            className="flex aspect-square cursor-pointer items-center justify-center rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
            style={{ width: "40px" }}
          >
            <a
        ...
        >
          <button
            className="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 h-9 w-9 rounded-full"
            type="button"
          >
            <svg
              width="15"
